...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/proprietary/hisilicon/liboverlay.so:$(TARGET_COPY_OUT_VENDOR)/lib/liboverlay.so \
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/proprietary/bt-wifi/hostapd_cli:$(TARGET_COPY_OUT_VENDOR)/bin/hostapd_cli \
    $(LOCAL_PATH)/proprietary/bt-wifi/libwpa_client.so:$(TARGET_COPY_OUT_VENDOR)/lib/libwpa_client.so
